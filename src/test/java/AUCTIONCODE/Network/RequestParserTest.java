...
class RequestParserTest {
    ...
    // =========================================================================
    // 5. KIỂM THỬ LOGIC TẠO VẬT PHẨM VÀ ĐẤU GIÁ (ADD_ITEM, CREATE_AUCTION)
    // =========================================================================
    ...
    @Test
    @DisplayName("Tạo phòng đấu giá mới với các ràng buộc số học")
    void testCreateAuctionValidation() {
        String loginRes = RequestParser.handle("LOGIN:test:1234");
        String sessionId = loginRes.split(":")[1];

        // Giả sử định dạng: CREATE_AUCTION:sessionId:itemId:startPrice:buyoutPrice:duration
        // Thử nghiệm truyền giá khởi điểm (startPrice) là số âm
        String response = RequestParser.handle("CREATE_AUCTION:" + sessionId + ":item123:-500.0:1000.0:3600");
